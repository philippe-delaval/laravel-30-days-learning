                ...
                <div class="flex items-center">
                    ...
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline space-x-4">
                            ...
                            <x-nav-link href="/troutrou" :active="request()->is('troutrou')">TrouTrou</x-nav-link>
                        </div>
                    </div>
                </div>
                <div class="hidden md:block">
        ...
        <div class="md:hidden" id="mobile-menu">
            ...
            <div class="border-t border-gray-700 pb-3 pt-4">
                <div class="flex items-center px-5">
                    ...
                    <div class="ml-3">
                        <div class="text-base font-medium leading-none text-white">klareg</div>
                        <div class="text-sm font-medium leading-none text-gray-400">klareg@example.com</div>
                    </div>
